...
public class BillController {
    ...
    public BillResponseDto autoGeneratedBillForMonth(@PathVariable String cardNumber) throws TransactionException, BillException, DateException, CardException {
    ...
    public BillResponseDto billPayment(@PathVariable String cardNumber) throws BillException, CardException, TransactionException {
